...
\INVARIANTS{
	\Invariant{inv1}{false}{$Access\_Requested \subseteq{} \natn{} \cprod{} EMPLOYEE \cprod{} ACTION \cprod{} RESOURCE \cprod{} DEADLINE \cprod{} \nat{} \cprod{} CONTEXT$}{\\A request is constitued by a time, the emitter, the action, the resource, the chain of approval, delay. NB: the chain of approval is copied from the security rule.}
	\Invariant{inv2}{false}{$PDistA \in{} PERMISSION \pfun{} \nat{}$}{}
	\Invariant{inv3}{false}{$PAcA \in{} PERMISSION \pfun{} CiO$}{}
}
\EVENTS{
\INITIALISATION{true}{}{
	\ACTIONS{false}{
		...
		\Action{act41}{$PAcA \bcmeq{} \emptyset{}$}{true}{}
	}
}
...
\EVT{Request\_Access}{false}{ordinary}{Can\_Request\_Access}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd5}{false}{$ac \in{} CONTEXT$}{true}{}
		...
		\Guard{grd2}{false}{$\exists{}u, r, v, p, org, act, c, rio, aio, vio, cio, acio \qdot{} e\mapsto{}u \in{} EA \land{} u\mapsto{}org\in{} OU \land{} rio = (r\mapsto{}org) \land{} rio \in{} RiO \land{} u\mapsto{}rio \in{} UR \land{} p\mapsto{}rio \in{} PRA \land{} vio = (v\mapsto{}org) \land{} vio \in{} ViO \land{} o\mapsto{}vio \in{} RV \land{} (p\mapsto{}vio) \in{} PVA \land{} aio = (act\mapsto{}org) \land{} (p\mapsto{}aio)\in{} PAA \land{} a\mapsto{}vio \in{} AV \land{} (a\mapsto{}aio) \in{} AA \land{} cio = (c\mapsto{}org) \land{} (p\mapsto{}cio) \in{} PCxA \land{} (p\mapsto{}dist)\in{}PDistA \land{} acio =(ac\mapsto{}org) \land{} (p\mapsto{}acio) \in{} PAcA$}{true}{}
	}
	\ACTIONS{true}{
		\Action{act1}{$Access\_Requested \bcmeq{} Access\_Requested \bunion{} \{t\mapsto{}e\mapsto{}a\mapsto{}o\mapsto{}GLOBAL\_DEADLINE\mapsto{}dist\mapsto{}ac\} $}{true}{}
	}
}
\EVT{Assign\_approval\_perimeter}{false}{ordinary}{}{}{
	...
	\ACTIONS{true}{
		\Action{act1}{$PDistA \bcmeq{} PDistA \bunion{} \{perm \mapsto{} dist\}$}{true}{}
	}
}
}
\END
