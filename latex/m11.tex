...
\INITIALISATION{true}{}{
	\ACTIONS{false}{
		...
		\Action{act43}{$time \bcmeq{} 0 $}{true}{}
		\Action{act44}{$at \bcmeq{} \emptyset{}$}{true}{}
		\Action{act45}{$PDA \bcmeq{} \emptyset{}$}{true}{}
		\Action{act46}{$Discarded\_Request \bcmeq{} \emptyset{}$}{true}{}
	}
}
\EVT{Concrete\_Model\_Generation}{true}{ordinary}{Concrete\_Model\_Generation}{}{
	\ACTIONS{false}{
		...
		\Action{act20}{$PAcA \bcmin{} PERMISSION \pfun{} CiO$}{false}{}
	}
}
...
\EVT{Define\_Security\_Rule}{false}{ordinary}{Define\_Security\_Rule}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd4}{false}{$\forall{} r, org \qdot{} cio = r\mapsto{}org \limp{} (\forall{} u1, p1, d1, org1 \qdot{} cor\mapsto{}u1\mapsto{}p1\mapsto{}d1 \in{} CA1 \land{} OU1(u1) = org1 \limp{} org1 = org)$}{true}{}
	}
	\ACTIONS{true}{
...
\EVT{Request\_Access}{false}{ordinary}{Request\_Access}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd2}{false}{$\exists{}u, r, v, p, org, act, c, rio, aio, vio, cio, acio \qdot{} e\mapsto{}u \in{} EA \land{} u\mapsto{}org\in{} OU \land{} rio = (r\mapsto{}org) \land{} rio \in{} RiO \land{} u\mapsto{}rio \in{} UR \land{} p\mapsto{}rio \in{} PRA \land{} vio = (v\mapsto{}org) \land{} vio \in{} ViO \land{} o\mapsto{}vio \in{} RV \land{} (p\mapsto{}vio) \in{} PVA \land{} aio = (act\mapsto{}org) \land{} (p\mapsto{}aio)\in{} PAA \land{} a\mapsto{}vio \in{} AV \land{} (a\mapsto{}aio) \in{} AA \land{} cio = (c\mapsto{}org) \land{} (p\mapsto{}cio) \in{} PCxA \land{} (p\mapsto{}dist)\in{}PDistA \land{} acio =(ac\mapsto{}org) \land{} (p\mapsto{}acio) \in{} PAcA \land{} (p\mapsto{}d) \in{} PDA$}{true}{}
...
\EVT{Treat\_Request}{false}{ordinary}{Treat\_Request}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd3}{false}{$\forall{}t1, dec1, s1 \qdot{} t1\mapsto{}r\mapsto{}s1\mapsto{}dec1 \in{} Request\_Treated \limp{} t > t1 \land{} s1 \neq{} s$}{true}{\\approve once per approver}
